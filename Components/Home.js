  ...
  return (
    <div className={`${css.bg} relative z-10 `}>
      <div className="homeText flex flex-col absolute ml-[8%] mt-[7%] z-10 ">
        <h1 className="text-white text-xl md:text-2xl">Looking For Right</h1>
        <h1 className="text-white text-xl md:text-5xl font-bold">
          {" "}
          Auto Repair<span className="block">Service ? </span>
        </h1>
        <button className="bg-white text-red-600 text-sm uppercase md:w-60 md:mt-5 md:py-2 px-0">
          schedule appointment
        </button>
      </div>
      <div className=" absolute top-36 right-[20%] md:right-2 z-10 bg-white rounded-lg ">
